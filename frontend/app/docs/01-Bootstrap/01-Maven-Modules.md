...
sidebar_position: 2
description: How the project is structured as a Maven multi-module build — 8 backend modules, parent POM, and the relativePath resolution that makes it work.
---
